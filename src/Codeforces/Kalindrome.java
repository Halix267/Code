...
public class Kalindrome {
    public static void main(String[] args) throws Exception {new Kalindrome().run();}
    ...
    void solve() throws Exception {
        ...
        while(t-->0){
            ...
            if(i>=j) out.println("YES");
            else{

                if(check(a,a[i]) || check(a,a[j])){
                    out.println("YES");
                }else out.println("NO");
            }
    ...
    boolean check(int[] a,int target){
        ...
        boolean ans = isPalindrome(l);
        return ans;
    }

    boolean isPalindrome(List<Integer> a){
