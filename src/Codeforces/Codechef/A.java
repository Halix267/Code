...
public class A {
    ...
    void helper(String s1,String s2,int i,int n,String h){
        if(i>=n) return;
        ...
        helper(s1,s2,i+1,n,h);
        helper(s1,s2+=h.charAt(i),i+1,n,h);
        helper(s1+=h.charAt(i),s2,i+1,n,h);


    }
    boolean isAnal(String s1,String s2){
