...
public class MakePower2 {
    public static void main(String[] args) throws Exception {new MakePower2().run();}
    ...
    void solve() throws Exception {
        ...
        while(t-->0){
            ...
            for(int i=0;i<64;i++){
                ...
                min = Math.min(min,checkCount(n,g));
                //out.println(checkCount(n,g)+" "+g);
            }
            out.println(min);
