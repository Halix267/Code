...
public class ArrayAndOp{
    public static void main(String[] args) throws Exception {new ArrayAndOp().run();}
    ...
    int Count(int tar,List<List<Integer>> ans){
    ...
    void BuildSub(int n,List<Integer> l,int i,boolean[] vis){
        if(i>n){
        if(l.size()==n ){
