...
public class ChatBan {
    public static void main(String[] args) throws Exception {new ChatBan().run();}
    ...
    void solve() throws Exception {
        ...
        while(t-->0){
           ...
           if(x>=tmp){
               ...
               x-=tmp;
               //out.println(x);
               long ggg = binarySearch(1l,(long)(k-1),x);
                ans+=(k-ggg-1);
                out.println(ans);

           }else{
                ans = binarySear(1l,(long)(k),x);
                out.println(ans);
           }
    ...
    long binarySear(long i,long j,long target){
        long ans= j;
        while(i<=j){
            long mid = (i+j)/2;
            long tmp = mid;
    ...
    long binarySearch(long i,long j,long target){
        long ans= j;
        long l = j;
        l*=(j+1);
        l/=2;
