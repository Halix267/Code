...
public class SlayDragon {
    public static void main(String[] args) throws Exception {new SlayDragon().run();}
    ...
    void solve() throws Exception {
        ...
        while(q-->0){
            ...
            //minimum ele pick so that sum is at least y;
            ...
            //out.println("pos: "+pos);
            if(pos!=-1){
                long aa =Math.max(0l,x-a.get(pos));
                long bb = Math.max(0l,(y-(sum-a.get(pos))));
    ...
    int BinarySearch(long[] a,long target){
