...
public class B{
    ...
    boolean helper(int[] a,int i,long al,long bb,long target){
        ...
        return dp[i]=helper(a,i+1,al+a[i],bb,target) || helper(a,i+1,al^a[i],bb,target) || helper(a,i+1,al,bb+a[i],target) || helper(a,i+1,al,bb^a[i],target);
