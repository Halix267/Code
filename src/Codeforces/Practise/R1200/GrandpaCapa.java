...
public class GrandpaCapa {
    public static void main(String[] args) throws Exception {new GrandpaCapa().run();}
        ...
        while(t-->0){
            ...
            while(i<j){
                if(s.charAt(i)==s.charAt(j)){
                    i++;
                    j--;
                }else if(s.charAt(i)!=s.charAt(j) && s.charAt(j)==cch1){
                    j--;
                    cnt1++;
                }else if(s.charAt(i)!=s.charAt(j) && s.charAt(i)==cch1){
                    i++;
                    cnt1++;
                }
            ...
            while(i<j){
                if(s.charAt(i)==s.charAt(j)){
                    i++;
                    j--;
                }else if(s.charAt(i)!=s.charAt(j) && s.charAt(j)==cch2){
                    j--;
                    cnt2++;
                }else if(s.charAt(i)!=s.charAt(j) && s.charAt(i)==cch2){
                    i++;
                    cnt2++;
                }
                else if(s.charAt(i)!=s.charAt(j)){
