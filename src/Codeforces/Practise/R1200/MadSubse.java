...
public class MadSubse {
    public static void main(String[] args) throws Exception {new MadSubse().run();}
...
//    void BuildSubse(String s,String tmp,int tar){
//        if (s.length() == 0) {
//            if(tmp.length()==tar)
//                 set.add(tmp);
//            return;
...
//
//
//        BuildSubse(s.substring(1), tmp + s.charAt(0),tar);
//
//
//        BuildSubse(s.substring(1), tmp,tar);
//
//    }
