...
public class PosionedDagger {
    public static void main(String[] args) throws Exception {new PosionedDagger().run();}
    ...
    void solve() throws Exception {
        ...
        while(t-->0){
           ...
           long low =1;
            ...
            while(low<=high){
                long mid = (low+high)/2;
                //out.println(mid+" "+low+" "+high);
               // out.println(helper(a,mid));
                if(helper(a,mid)>=h){
                    ans = mid;
                    high = mid-1;
                }else{
