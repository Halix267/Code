...
class dna {
    public static void main(String[] args) throws Exception {new dna().run();}
    ...
    void solve() throws Exception {
        ...
        for(int k=1;k<n;k++){
            ...
            while(i<a.length() && j<b.length()){
                ...
                if((a.charAt(i)=='A' && b.charAt(j)=='T') || (a.charAt(i)=='T' && b.charAt(j)=='A')){
                    cnt++;
                }

                if((a.charAt(i)=='C' && b.charAt(j)=='G') || (a.charAt(i)=='G' && b.charAt(j)=='C')){
                    cnt++;
                }
                i++;
                j++;
