            ...
            for(int i=0;i<n;i++){
                for(int j=0;j<m;j++){
                    ...
                    if(n%2==0 && m%2==0){
                        ...
                        d = Math.min(d,Math.abs(a1-i)+Math.abs(b1-j));
                        d= Math.min(d,Math.abs(a1-i)+Math.abs(b2-j));
                        d= Math.min(d,Math.abs(a2-i)+Math.abs(b1-j));
                        d=Math.min(d,Math.abs(a2-i)+Math.abs(b2-j));
                        set.add(min+d);
                    }
                    else if(n%2!=0 && m%2!=0){
                        int a1 = n/2;
